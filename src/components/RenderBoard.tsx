...
import { RenderBoardProps, boardSize, Player, PieceState, SquareId } from '../types'
...
export const RenderBoard = ({
    ...
    const fieldsInRadiusOfPower = selectedSquare ? getReachableFields(selectedSquare, state) : []
